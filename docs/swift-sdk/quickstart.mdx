...
<Tip>
**Want a working app right now?** Clone [bithuman-apps](https://github.com/bithuman-product/bithuman-apps) — Mac (`swift run BithumanMac`), iPad, and iPhone reference apps that consume the SDK out of the box. Same code as this quickstart, just pre-wired. Walk through this page if you're integrating the SDK into an existing project; clone the reference app if you want to read finished code.
</Tip>
...
- **[Reference apps](https://github.com/bithuman-product/bithuman-apps)** — Mac, iPad, and iPhone source-available apps that consume the SDK. Drag-drop face swap, PiP, Stage Manager widget, all wired up.
