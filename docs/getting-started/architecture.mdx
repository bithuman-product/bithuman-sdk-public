...
| **Public binary Swift Package** ([bithuman-kit-public](https://github.com/bithuman-product/bithuman-sdk-public)) | Public — wraps the released `.xcframework` | bitHuman ToS |
