...
<CardGroup cols={2}>
  ...
  <Card title="Voice (TTS)" icon="waveform-lines" href="/api-reference/voice">
    Synthesize speech in 31 languages, 10 built-in voices
  </Card>
...
worker endpoint (used by the avatar-dispatcher), and the
