...
- **Native Android** — `ai.bithuman:sdk:1.17.0` from Maven Central. See [Kotlin SDK overview](/kotlin-sdk/overview) + [Streaming API](/kotlin-sdk/streaming).
...
The reference app at [`bithuman-apps/flutter/bithuman/example/`](https://github.com/bithuman-product/bithuman-apps/tree/main/flutter/bithuman/example) is the canonical Essence cross-platform demo.
