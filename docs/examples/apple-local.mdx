...
<Steps>
  ...
  <Step title="Run agent">
    ...
    cd bithuman-sdk-public/Examples/integrations/offline-mac
    ```
    [View source code on GitHub](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/integrations/offline-mac)
...
[Complete macOS Offline Example](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/integrations/offline-mac)
