...
|---|---|---|
| **Python (library)** | macOS arm64, Linux x86_64, Linux aarch64, Windows x86_64 | `pip install bithuman` |
| **Swift** | macOS arm64, iOS device + simulator | SwiftPM `bitHumanKit` |
| **Kotlin** | Android `arm64-v8a` | Maven `ai.bithuman:sdk` |
| **bithuman CLI** | macOS, Linux, Windows | `brew install bithuman-product/bithuman/bithuman` or `pip install bithuman-cli` |
...
| **Engine source** (`libessence` in [`bithuman-sdk`](https://github.com/bithuman-product/bithuman-sdk)) | Private (proprietary) |
| **SDK source** (Python / Swift / Kotlin / Rust, same repo) | Private (proprietary) |
| **App source** (CLI, Flutter, Expression demos in [`bithuman-apps`](https://github.com/bithuman-product/bithuman-apps)) | Private (proprietary) |
