...
For a cloud voice agent with an avatar, use the LiveKit plugin instead
of driving the runtime yourself:

```bash
pip install livekit-plugins-bithuman
```

Drop `bithuman.AvatarSession(...)` into your agent worker. See
