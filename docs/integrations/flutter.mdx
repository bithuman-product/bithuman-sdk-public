...
The example app at [`bithuman-apps/flutter/bithuman/example/`](https://github.com/bithuman-product/bithuman-apps/tree/main/flutter/bithuman/example) is the canonical cross-platform Essence demo, including a settings sheet that hot-updates the system prompt mid-session.

For Expression on Apple Silicon, use the native Swift [Mac](https://github.com/bithuman-product/bithuman-apps/tree/main/expression/mac) or [iPad](https://github.com/bithuman-product/bithuman-apps/tree/main/expression/ipad) reference apps — the Flutter plugin covers the Essence cross-platform path.

---

## Flutter + LiveKit + Python stack

Use this architecture when the avatar runs on a server you control and the Flutter app is just a subscriber. Both Essence and Expression are valid choices for the Python agent — see the [LiveKit Cloud Plugin](/deployment/livekit-cloud-plugin) guide.
