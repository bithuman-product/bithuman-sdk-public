...
<Steps>
  ...
  <Step title="Download the DMG">
    **[Download bitHuman Halo →](https://www.bithuman.ai/halo)** (always-current build, Developer ID signed + notarized by Apple)
...
<CardGroup cols={2}>
  ...
  <Card title="Examples repo" icon="github" href="https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples">
