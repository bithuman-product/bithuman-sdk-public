...
- Thai, Chinese, Arabic, and additional language support via Cartesia sonic-3

### Streaming & Performance
- `sync_transcription=False` for instant text streaming to the UI (no longer waits for TTS audio sync)
