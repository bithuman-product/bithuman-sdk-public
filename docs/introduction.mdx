...
Each tab maps to a working example in [bithuman-examples](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples).
...
- **[AGENTS.md](https://github.com/bithuman-product/bithuman-sdk-public/blob/main/Examples/AGENTS.md)** — Repository-level agent instructions
