...
<Note>
This is the **Python SDK** path on macOS — `pip install bithuman` plus a bundled Swift daemon, called from Python. If you're building a **native Swift app** (SwiftUI / AppKit / UIKit) on Mac, iPad, or iPhone, see the [Swift SDK quickstart](/swift-sdk/quickstart) and the bithuman-apps reference apps instead.
</Note>
...
<Accordion title="Clone the full example repo">
  ...
  cd bithuman-sdk-public/Examples/self-hosted/expression-apple
