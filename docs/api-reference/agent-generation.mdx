...
|-------|------|-------------|
| `progress` | float (0.0–1.0) | Generation progress as a fraction. `1.0` means complete. |
| `progress_msg` | string | Human-readable progress description. |
| `current_step` | string | Current generation step name (e.g. `lip_created`). |
...
| `402` | Insufficient credits (agent generation costs 250 credits) |
