...
description: "Run an Essence avatar on Mac with the local Apple speech stack (Apple STT + Apple voices + Silero VAD). Voice never leaves your device. M2+ supported. For on-device Expression avatars on M3+, see Expression on macOS."
keywords:
  - bitHuman macOS
