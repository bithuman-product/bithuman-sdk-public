...
Use the [full example](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/expression-selfhosted) for a complete setup with LiveKit, an AI agent, and a web frontend:
...
The full reference compose at [`bithuman-examples/expression-selfhosted`](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/expression-selfhosted) ships with all of these defaults.
...
<CardGroup cols={2}>
  <Card title="Docker Example" icon="docker" href="https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/expression-selfhosted">
