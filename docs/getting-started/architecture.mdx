...
| Run from CLI on Mac | `brew install bithuman-product/bithuman/bithuman` | CLI tool (single Rust binary) |
...
| **CLI + Flutter plugin + Expression demos** ([`bithuman-apps`](https://github.com/bithuman-product/bithuman-apps)) | Private (proprietary) |
