...
For the full SDK downloads matrix, pre-built wheels, device compatibility table, and install commands for every platform, see [releases.bithuman.ai](https://releases.bithuman.ai).
