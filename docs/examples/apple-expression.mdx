...
<Steps>
  ...
  <Step title="Download a packed Expression .imx">
    Grab one from your bitHuman dashboard, or pack your own from raw weights with `bithuman pack` — run `bithuman pack --help` after `pip install bithuman` for the full flag reference.
  </Step>
