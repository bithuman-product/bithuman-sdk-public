...
<Tip>
For a full web-based setup with LiveKit and a browser UI, see the [Docker example](https://github.com/bithuman-product/examples/tree/main/essence-selfhosted) — run `docker compose up` and open `http://localhost:4202`.
</Tip>
