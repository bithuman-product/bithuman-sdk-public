...
[Full working example on GitHub](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/self-hosted/essence-cpu)
...
Or jump straight to the [Docker App](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/self-hosted/essence-cpu) for a complete end-to-end setup.
