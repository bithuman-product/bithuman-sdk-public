...
```
models/
├── bithuman-expression/    ← video VAE (1.6 GB)
...
# Expected layout:
#   models/bithuman-expression/   (VAE_LTX contents, 1.6 GB)
#   models/wav2vec2-base-960h/    (1.1 GB)
#   models/dit_lite_fp16.trt      (2.9 GB)
#   models/turbo-vaed/            (162 MB)
