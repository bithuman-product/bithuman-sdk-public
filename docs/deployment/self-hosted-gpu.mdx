...
The full reference compose at [`Examples/expression-selfhosted`](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/expression-selfhosted) ships with all of these defaults.
