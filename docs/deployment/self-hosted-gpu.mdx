...
Use the [full example](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/self-hosted/expression-gpu) for a complete setup with LiveKit, an AI agent, and a web frontend:
...
The full reference compose at [`Examples/self-hosted/expression-gpu`](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/self-hosted/expression-gpu) ships with all of these defaults.
...
<CardGroup cols={2}>
  <Card title="Docker Example" icon="docker" href="https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/self-hosted/expression-gpu">
