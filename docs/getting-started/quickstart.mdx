...
[Full working example on GitHub](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/essence-selfhosted)
...
Or jump straight to the [Docker App](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/essence-selfhosted) for a complete end-to-end setup.
