...
If you run the self-hosted Expression GPU container, it returns its own error responses on its local endpoints. See [Deployment → Self-hosted GPU](/guides/deployment) for details.
