...
<Steps>
  ...
  <Step title="Run">
    ...
    ```
    [View source code on GitHub](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/essence-selfhosted)
...
<Tip>
For a full web-based setup with LiveKit and a browser UI, see the [Docker example](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/essence-selfhosted) — run `docker compose up` and open `http://localhost:4202`.
</Tip>
