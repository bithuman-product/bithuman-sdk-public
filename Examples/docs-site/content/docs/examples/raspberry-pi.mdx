...
description: Run avatar agent on Raspberry Pi for IoT and edge devices.
---

Suited for IoT, kiosks, and edge devices.

![Raspberry Pi Device](/images/example-raspberry-pi-device.jpg)
...
![Raspberry Pi UI](/images/example-raspberry-pi-ui.jpg)
