...
<AccordionGroup>
  ...
  <Accordion title="API Secret">
    Your **API secret** is the key that authenticates your application with bitHuman services. It looks like `sk_bh_...` and you get it from the [Developer Dashboard](https://www.bithuman.ai/#developer).
