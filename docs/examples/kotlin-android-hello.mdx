...
dependencies {
    implementation("ai.bithuman:sdk:1.12.0")   // Maven Central
}
```

## 2. Compose frames into an `ImageView`

The canonical snippet from the [Kotlin SDK README](https://github.com/bithuman-product/bithuman-sdk/blob/main/cpp/bindings/kotlin/README.md):
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture" icon="diagram-project" href="/getting-started/architecture">
    How the AAR sits on top of libessence.
  </Card>
</CardGroup>
