---
title: "Local Voice Pipeline on macOS (Essence avatar + Apple Speech)"
sidebarTitle: "Local Voice Stack (Essence)"
description: "Run an Essence avatar on Mac with the local Apple speech stack. Voice never leaves your device. M2+ supported. For on-device Expression avatars on M3+, see Expression on macOS."
keywords:
  - bitHuman macOS
...
<Tip>
  Looking for the **on-device Expression** avatar (custom face, 25 FPS, no GPU)? See [Expression on macOS](/examples/apple-expression). This page covers the local *voice* stack (STT/TTS/VAD) paired with an Essence avatar.
</Tip>

<Warning>
  **Preview — private distribution.** The `bithuman-voice` wheel referenced below is not currently published on PyPI. Reach out on [Discord](https://discord.gg/ES953n7bPA) or through [bitHuman support](https://bithuman.ai) to request access to the voice pipeline.
</Warning>
...
<Steps>
  ...
  <Step title="Run agent">
    ...
    cd bithuman-sdk-public/Examples/integrations/macos-offline
    ```
    [View source code on GitHub](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/integrations/macos-offline)
...
[Complete macOS Offline Example](https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/integrations/macos-offline)
