...
description: "Real-time avatar from your microphone."
icon: "microphone"
---
...
<Steps>
  ...
  <Step title="Run">
    ...
    ```
    [View source code on GitHub](https://github.com/bithuman-product/examples/tree/main/public-sdk-examples/02-microphone)
  </Step>
  <Step title="Usage">
