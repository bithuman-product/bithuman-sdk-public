...
<Steps>
  <Step title="Sign up">
    Create an account at [imaginex.bithuman.ai](https://imaginex.bithuman.ai)
  </Step>
  ...
  <Step title="Download an avatar model">
    Download an avatar model (`.imx` file) from [Community Models](https://imaginex.bithuman.ai/#community).
