...
<Note>
This is the **Python SDK** path on macOS — `pip install bithuman` plus a bundled Swift daemon, called from Python. If you're building a **native Swift app** (SwiftUI / AppKit / UIKit) on Mac, iPad, or iPhone, see the [Swift SDK quickstart](/swift-sdk/quickstart) and the [bithuman-apps reference apps](https://github.com/bithuman-product/bithuman-apps) instead.
</Note>
