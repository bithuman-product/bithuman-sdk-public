...
<CardGroup cols={2}>
  ...
  <Card title="swift/macos-avatar (preview)" icon="apple" href="https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/swift/macos-avatar">
  ...
  <Card title="swift/essence-playback (preview)" icon="apple" href="https://github.com/bithuman-product/bithuman-sdk-public/tree/main/Examples/swift/essence-playback">
