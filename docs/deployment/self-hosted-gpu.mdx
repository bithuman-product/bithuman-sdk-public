...
description: "Deploy the bitHuman expression-avatar GPU container. Any face image, 250+ FPS, 8 concurrent sessions per GPU. Docker setup, HTTP API reference, and troubleshooting."
icon: "gpu-card"
---
...
<CardGroup cols={2}>
  <Card title="Docker Example" icon="docker" href="https://github.com/bithuman-product/examples/tree/main/expression-selfhosted">
