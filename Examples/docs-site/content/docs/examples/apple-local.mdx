...
description: Private AI using Mac's built-in speech processing.
---
...
- Enable "Speech Recognition" in Privacy and Security
...
**Want edge deployment?** -- Try [Raspberry Pi Agent](/docs/examples/raspberry-pi)

**Need simpler setup?** -- Try [OpenAI Agent](/docs/examples/openai-agent)
